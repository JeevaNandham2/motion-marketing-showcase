  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-12">
              ...
              Let&rsquo;s create your success story together.
            </p>
      ...
      <footer className="bg-black text-white py-16 relative overflow-hidden">
        <div className="absolute inset-0">
          <motion.div
            animate={{ scale: [1, 1.2, 1], rotate: [0, 180], opacity: [0.1, 0.2, 0.1] }}
          ...
          />
          <motion.div
            animate={{ scale: [1.2, 1, 1.2], rotate: [180, 0], opacity: [0.15, 0.25, 0.15] }}
            transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
          ...
          {Array.from({ length: 4 }).map((_, i) => (
            <motion.div
              ...
              animate={{ y: [-20, 20, -20], opacity: [0.3, 0.8, 0.3], scale: [0.8, 1.2, 0.8] }}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-white/80 mb-6 max-w-md">
                We&apos;re a full-service digital marketing agency in Chennai dedicated to helping
                businesses in Kilpauk and beyond grow their online presence and achieve measurable results.
              </p>
              <div className="flex space-x-4">
                {[
                  {
                    icon: Instagram,
                    href: "https://www.instagram.com/adorycreatives?igsh=MWZibW95bHBqeHFjYg==",
                    label: "Instagram",
                  },
                  {
                    icon: Facebook,
                    href: "https://www.facebook.com/profile.php?id=61579255075163",
                    label: "Facebook",
                  },
                  { icon: Twitter, href: "#", label: "Twitter" },
                  {
                    icon: Linkedin,
                    href: "https://www.linkedin.com/in/adory-creatives-a17769377?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
                    label: "LinkedIn",
                  },
                ].map((social) => (
                  <motion.a
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white/80">
                    1st Cross St, Kilpauk Garden Colony, Kilpauk, Chennai, Tamil Nadu 600010
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          >
            <p className="text-white/60 text-sm">©2025 Adory Creatives. All rights reserved.</p>
