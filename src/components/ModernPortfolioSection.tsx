...
const ModernPortfolioSection = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      driveLink: "https://drive.google.com/drive/folders/6pqr678stu901vwx234"
    }
  ];
              ...
              >
                <Card className="overflow-hidden transition-all duration-500 bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-border/30 hover:border-primary/50 hover:shadow-[0_20px_40px_hsl(0_0%_0%/0.3)] relative">
                  ...
                  <CardContent className="p-6 relative">
                    <motion.h3 
                      className="text-xl font-bold mb-3 bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent group-hover:from-primary group-hover:to-accent transition-all duration-300"
                    >
                      {item.title}
                    </motion.h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      {Object.entries(item.metrics).map(([key, value], index) => (
                        <motion.div 
                          ...
                          transition={{ delay: index * 0.1 }}
                        >
                          <div className="text-lg font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">{value}</div>
